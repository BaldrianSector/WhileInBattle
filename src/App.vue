...
<template>
  ...
  <div class="desktop-only">
    ...
    <BlockSection
      id="hero"
      class="bg-[#161718] hero-section block-section"
      msg="Hero Section"
    >
    ...
    <BlockSection
      id="quote"
      class="bg-[#AA7246] block-section"
      msg="Quote Section"
    >
      <div class="col-span-12">
        <Quote :quote="t('quote')" />
        <p
          class="italic absolute bottom-24 right-24 text-[#BCACAC] text-lg hover:text-cream transition duration-200 ease-in-out"
        >
          -&nbsp<a
  ...
  <div class="mobile-only flex flex-col place-content-center h-screen">
    ...
    <p class="text-xl leading-2 px-10 text-center max-w-2xl mx-auto">
      {{ t("mobile-message") }}
    </p>
    <img
      src="./assets/images/Noise.png"
